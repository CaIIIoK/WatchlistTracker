...
class TVShowEdit extends Component {
    ...
    async componentDidMount() {
        if (this.props.match.params.id !== 'new') {
            const show = await (await fetch(`/tvshows/${this.props.match.params.id}`)).json();
...
async handleSubmit(event) {
    ...
    await fetch('/tvshows' + (item.id ? '/' + item.id : ''), {
            ...
            <Container>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormGroup>
                        ...
                        <Button color="secondary" tag={Link} to="/tvshows">Cancel</Button>
                    </FormGroup>
                </Form>
            </Container>
        </div>
